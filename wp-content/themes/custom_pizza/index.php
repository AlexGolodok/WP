...
<html lang="en">
  <head>
    ...
    <?php wp_head(); // подключение в хедере стилей - читаем на wp-kama.ru как работает данная функция ?> 
  </head>
  <body>
  ...
  <script src="wp-content/themes/custom_pizza/assets/js/jquery.min.js"></script>
  <script src="wp-content/themes/custom_pizza/assets/js/jquery-migrate-3.0.1.min.js"></script>
  <script src="wp-content/themes/custom_pizza/assets/js/popper.min.js"></script>
  <script src="wp-content/themes/custom_pizza/assets/js/bootstrap.min.js"></script>
  <script src="wp-content/themes/custom_pizza/assets/js/jquery.easing.1.3.js"></script>
  <script src="wp-content/themes/custom_pizza/assets/js/jquery.waypoints.min.js"></script>
  <script src="wp-content/themes/custom_pizza/assets/js/jquery.stellar.min.js"></script>
  <script src="wp-content/themes/custom_pizza/assets/js/owl.carousel.min.js"></script>
  <script src="wp-content/themes/custom_pizza/assets/js/jquery.magnific-popup.min.js"></script>
  <script src="wp-content/themes/custom_pizza/assets/js/aos.js"></script>
  <script src="wp-content/themes/custom_pizza/assets/js/jquery.animateNumber.min.js"></script>
  <script src="wp-content/themes/custom_pizza/assets/js/bootstrap-datepicker.js"></script>
  <script src="wp-content/themes/custom_pizza/assets/js/jquery.timepicker.min.js"></script>
  <script src="wp-content/themes/custom_pizza/assets/js/scrollax.min.js"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="wp-content/themes/custom_pizza/assets/js/google-map.js"></script>
  <script src="wp-content/themes/custom_pizza/assets/js/main.js"></script>
  <?php wp_footer(); ?>  
  </body>
</html>
